...
. Test that the `listIngredients` command lists ingredients with key word and/or ingredient quantity falling below ingredient warning amount (ingredient panel)
...
.. Test case: `addIngredient in/tomato q/20 w/ 10 u/whole`  +
...
Expected: 4 ingredients, tomato, tomato ketchup, tomato soup and potato is added into ingredient panel. Upon success, ingredient panel should look like this:
+
...
Expected: 3 ingredients, tomato, tomato ketchup and tomato soup containing the word "tomato" is listed on the ingredient panel. Upon success, ingredient panel should look like this:
+
...
.. Test case: `consumeIngredient i/1 q/15`  +
Expected: 1 ingredient, tomato, is consumed by 15 whole tomatoes, ingredient quantity of tomato in ingredient panel changes to 5 whole tomatoes. Upon success, ingredient panel should look like this:
+
...
image::listIngredients_tomato_warningamt2.png[width=1000]
